...
<body>
    ...
    <div class="container-fluid " style="height: 80px; background-color:  #4850BB;">
        <div class="row">
            <h2 style="text-align: center; padding-top :20px;">Technologies we provide </h2>
        </div>
    </div>
    <!-- middlenav bar ends -->
    ...
    <div class="col-sm-12">
        <div class="row">
            <img src="abg.jpg" style="height: 400px; width: 100%; background-size: cover; back" />
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="col-sm-12">
            <div class="row" my-5>
                ...
                <div class="col-sm-4 text-center">
                    <h4>Php</h4>
                    <img src="3.png" style=" height: 200px; width= 300px ;" />

                </div>

                <div class="col-sm-4 text-center">
                    <h4>Android technology</h4>
                    <img src="1.jfif" style=" height: 200px; width= 300px ;" />
                </div>

                <div class="col-sm-4 text-center">
                    <h4>Python</h4>
                    <img src="4.jfif" style=" height: 200px; width= 300px ;" />
                </div>
        ...
        <div class="col-sm-12 my-5">
            <div class="row">
                ...
                <div class="col-sm-4 text-center">
                    <h4>Java</h4>
                    <img src="5.jfif" style=" height: 200px; width= 300px ;" />
                </div>

                <div class="col-sm-4 text-center">
                    <h4>DSA</h4>
                    <img src="dsa.jfif" style=" height: 200px; width= 300px ;" />
                </div>

                <div class="col-sm-4 text-center">
                    <h4>React Js</h4>
                    <img src="react.jfif" style=" height: 200px; width= 300px ;" />
                </div>
